...
# barplots
ggplot(Wshed.outw, aes(x = Wshed, y = log(totalDiv.All0))) +
  geom_bar(stat = 'identity') +
  scale_x_continuous(expand = c(0,0)) +
  scale_y_continuous(expand = c(0,0)) +
  labs(y = "log(All 0)") +
...
ggplot(Wshed.outw.long, aes(x = Wshed, y = lPercentChange, fill = NodeValue)) +
  geom_bar( stat = 'identity', position = 'dodge') +
