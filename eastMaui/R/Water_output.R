...
diversion.fun = function(nodesInput, waterInput){
  ...
  diverted$E002 = waterInput[2, 3]*nodesInput[49, c(8:11)] + waterInput[3, 3]*nodesInput[228, 3]

  diverted$E003 = waterInput[3, 3]*nodesInput[228, c(8:11)]

  diverted$E004 = waterInput[4, 3]*nodesInput[196, c(8:11)]

  diverted$E005 = waterInput[5, 3] + waterInput[6, 3]*nodesInput[50, 3]

  diverted$E006 = waterInput[6, 3] + waterInput[7, 3]*nodesInput[297, 3]
  ...
  diverted$E012 = waterInput[12, 3] + waterInput[13, 3]*nodesInput[195, 3]
  ...
  diverted$E046 = waterInput[46 ,3] + waterInput[52, 3]*nodesInput[222, 3]
  ...
  diverted$E058 = waterInput[58 ,3] + waterInput[63, 3]*nodesInput[214, 3]
  ...
  diverted$E082 = waterInput[82 ,3] + waterInput[83, 3]*nodesInput[280, 3]

  diverted$E083 = waterInput[83 ,3]

  diverted$E084 = waterInput[84 ,3]

  diverted$E085 = waterInput[85 ,3] + waterInput[89, 3]*nodesInput[197, 3]
  ...
  diverted$E095 = waterInput[95 ,3] + waterInput[96, 3]*nodesInput[256, 3]
  ...
  diverted$E099 = waterInput[99 ,3] + waterInput[100, 3]*nodesInput[253, 3]
  ...
  diverted$E109 = waterInput[109,3] + waterInput[113, 3]*nodesInput[74, 3]
  ...
  diverted$E120 = waterInput[120, 3] + waterInput[122, 3]*nodesInput[116, 3]
  ...
  diverted$E132 = waterInput[132, 3]*nodesInput[60, c(8:11)]
  ...
  diverted$E139 = waterInput[139, 3] + waterInput[141, 3]*nodesInput[167, 3]
  ...
  diverted$E152 = waterInput[152, 3] + waterInput[153, 3]*nodesInput[212, 3]
  ...
  diverted$E159 = waterInput[159, 3] + waterInput[160, 3]*nodesInput[159, 3]
  ...
  diverted$E162 = waterInput[162, 3] + waterInput[163, 3]*nodesInput[172, 3]
  ...
  # diverted$E171=  list()  NO OUTLdiverted$ET NODdiverted$E IN GIS FILdiverted$ES
  # diverted$E171 = waterInput[171, 3]*nodesInput[95, c(8:11)]*waterInput[170, 3]*nodesInput[69, c(8:11)]*waterInput[169, 3]*nodesInput[154, c(8:11)]*waterInput[168, 3]*nodesInput[18, c(8:11)]+ waterInput[172, 3]*nodesInput[177, 3]+ waterInput[173, 3]*nodesInput[*NODdiverted$E*, 3]
  ...
  # Removed node 173 from diverted$E175 - no stream outlet node in GIS file : * waterInput[173, 3]*nodesInput[0, c(8:11)]
  ...
  diverted$E181 = waterInput[181, 3] + waterInput[184, 3]*nodesInput[261, 3]

  diverted$E182 = waterInput[182, 3]

  diverted$E183 = waterInput[183, 3] + waterInput[182, 3]*nodesInput[262, 3]
  ...
  diverted$E187 = waterInput[187, 3] + waterInput[186, 3]*nodesInput[256, 3]

  diverted$E188 = waterInput[188, 3]

  diverted$E189 = waterInput[189, 3] + waterInput[194, 3]*nodesInput[123, 3]

  diverted$E190 = waterInput[190, 3] + waterInput[191, 3]*nodesInput[299, 3]
  ...
  diverted$E194 = waterInput[194, 3] + waterInput[196, 3]*nodesInput[296, 3]
